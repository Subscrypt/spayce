        ...
        <>
          <div className="flex flex-row sm:flex-col gap-1 p-2">
            <Button
              ...
              isFocused={pathName() === "/#about" ? true : false}
            />
            <Button
              icon="🛠️"
              text="How it works"
              onClick={() => handleNavigation("/#howitworks", router)}
              isFocused={pathName() === "/#howitworks" ? true : false}
            />
            <Button
              icon="📝"
              text="Features"
              onClick={() => handleNavigation("/#features", router)}
              isFocused={pathName() === "/#features" ? true : false}
            />
          </div>
        </>
      }
