    ...
    return (
        <div className='overflow-scroll rounded-2xl'>
            <div id='about'>
                ...
                <div id='howitworks' className='flex flex-col gap-6 px-12 py-20 w-2/3 text-5xl font-bold text-gray-900 leading-none'>
                ...
                <div id='features' className='flex flex-col gap-6 px-12 py-20 w-2/3 text-5xl font-bold text-gray-900 leading-none'>
